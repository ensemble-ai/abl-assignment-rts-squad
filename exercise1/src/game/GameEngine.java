...
public class GameEngine extends JPanel implements KeyListener {
	...
	private boolean chaserBullet = true;
	...
	/** target position of the MoveAction */
	...
	/** Change Agent name from ChaserAgent to new agent
	/**
	...
	*/
	...
	/**
	 * create void for move action for input parameters (x, y, id)
	 * 
	 */
	/**
